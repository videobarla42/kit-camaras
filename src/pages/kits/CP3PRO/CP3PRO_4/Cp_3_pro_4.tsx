...
// Importar imágenes
import imagen1 from '@/assets/CP3_PRO/cp_3_pro_3.webp';

import headerImage from '@/assets/CP3_PRO/cp_3_pro_3.webp';
...
const Cp_3_pro_4: React.FC = () => {          
  ...
  const abrirWhatsApp = () => {
    ...
    const message = 'Hola, Me Interesa el kit de 4 camaras tenda CP3PRO 3mpx + Memorias micro sd, Puede Brindarme Mas Informacion?';
  ...
  const carruseles = [
    {
      title: '4 Cámaras de seguridad Roboticas de 3 MP',
      description:
      ...
      features: [
        '4 Cámaras de seguridad Roboticas de 3 MP',
    ...
    {
      title: ' 4 Fuentes de Energía Tenda',
      description:
        'Fuentes de energía 5V 1A marca Tenda, suministro estable y confiable rendimiento continuo y seguro.',
      features: [
        ' 4 Fuentes de Energía Tenda (incluidas dentro de la caja original de la camara)',
...
<button className={styles["boton-texto"]}>{producto.botonTexto}</button>
  ...
  Pago contra entrega solo en Bucaramanga y su área metropolitana, por un valor total de $690,000 COP. ¡Domicilio gratis!
  ...
  />
      ...
      <WhatsAppButton
        ...
        message="¡Hola! Me gustaría conocer mas del Kit de una 4 cámaras robotica (3mpx) de TENDA + 4 MICRO SD 64 GB IMOU, Puede Brindarme Mas información.?'"
      />
...
<Suspense fallback={<div>Cargando...</div>}>
  <HeroHeader
    ...
    descripcion={<span className={styles.heroDescription}>Kit de 4 cámaras Roboticas 3mpx TENDA, 4 micro sd 64gb + 4 fuentes de energia.</span>}
    precio="690,000"
  >
    <BotonCompra
      texto="Compra el Kit!"
      ...
      {modalAbierto && (
        <Suspense fallback={<div>Cargando...</div>}>
          <ModalCompra
            ...
            tituloModal="Confirme la Compra del Kit de 4 cámaras roboticas de (3mpx) TENDA + 4 MICRO SD 64 GB IMOU"
...
<Suspense fallback={<div>Cargando...</div>}>
  <HeroHeader
    ...
    titulo={<span className={styles.heroTitle}>Solo para Bucaramanga y el área metropolitana</span>}
    subtitulo={<span className={styles.heroSubtitle}>boton de llamada + detección de llanto, incluye detección de humanos!</span>}
    descripcion={<span className={styles.heroDescription}>Kit de 4 cámaras Roboticas de 3mpx TENDA, 4 micro sd 64gb + 4 fuentes de energia.</span>}
    precio="690,000"
  >
  </HeroHeader>
</Suspense>
      ...
      <Suspense fallback={<div>Cargando...</div>}>
        <Formulario
          titulo="confirma la Compra de 6 cámaras tenda cp3 pro 3mpx + 6 memorias sd de 64 gb"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "Product",
          "name": "Kit de 4 cámaras Roboticas de 3mpx TENDA + 4 micro sd 64gb imou",
          "image": [
            imagen1,
  imagen50,
  imagen51,
  ...
  Image1504,
        ...
        "description": "Kit de una 4 cámaras roboticas de (3mpx) TENDA + 4 MICRO SD 64 GB IMOU, ideal para todo tipo de negocio, casa u oficina.",
        "brand": {
          "@type": "Brand",
          "name": "TENDA"
        },
  ...
  "seller": {
    "@type": "Organization",
    "name": "S24 Seguridad Electrónica"
  }
        }
      })}
    </script>
