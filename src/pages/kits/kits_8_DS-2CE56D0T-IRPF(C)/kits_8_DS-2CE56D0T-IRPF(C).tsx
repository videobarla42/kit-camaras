 ...
 interface ImagenProps {
    ...
    const carruseles = [
      ...
      },
      {
        ...
        features: [
          'Cámaras Domo de 2 Mpx',
          'Resolución TURBOHD 1080p',
          'Lente de 2.8 mm para amplia visión',
      ...
      },
      {
        ...
        features: [
          'Capacidad de 1 TB para grabaciones extensas',
          'Tecnología AllFrame para transmisión sin cortes',
      ...
      },
      {
        ...
        features: [
          ...
          'Compatibilidad TURBO 4 EN 1',
          'Soporte para larga distancia',
      ...
      },
      {
        ...
        features: [
          'Conexión segura de cables eléctricos',
      ...
      },
      {
        ...
        features: [
          'Cable UTP Cat 5e de alta calidad',
          'Longitud de 100 metros',
          'Ideal para transmisión de datos y video',
