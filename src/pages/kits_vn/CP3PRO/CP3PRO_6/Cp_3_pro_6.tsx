...
import imagen50 from "@/assets/CP3_PRO/cp_3_pro_18.webp";
...
import imagen61 from '@/assets/CP3_PRO/cp_3_pro_18.webp';
...
import imagen78 from '@/assets/micro_sd_imou_64_gb/4.webp';
...
const Cp_3_pro_6: React.FC = () => {          
  ...
  const abrirWhatsApp = () => {
    ...
    const message = 'Hola, Me Interesa el kit de 6 camaras tenda CP3PRO 3mpx + Memorias micro sd, Puede Brindarme Mas Informacion?';
...
/>,
  ...
  Pago contra entrega solo en Bucaramanga y su área metropolitana, por un valor total de $999,000 COP. ¡Domicilio gratis!
  ...
  />
      ...
      <WhatsAppButton
        ...
        message="¡Hola! Me gustaría conocer mas del Kit de una 6 cámaras robotica (3mpx) de TENDA + 6 MICRO SD 64 GB IMOU, Puede Brindarme Mas información.?'"
      />
      ...
      {modalAbierto && (
        <Suspense fallback={<div>Cargando...</div>}>
          <ModalCompra
            ...
            tituloModal="Confirme la Compra del Kit de 6 cámaras roboticas (3mpx) TENDA + 6 MICRO SD 64 GB IMOU"
...
<Suspense fallback={<div>Cargando...</div>}>
  <HeroHeader
    ...
    titulo={<span className={styles.heroTitle}>Solo para Bucaramanga y el área metropolitana</span>}
    subtitulo={<span className={styles.heroSubtitle}>boton de llamada + detección de llanto, incluye detección de humanos!</span>}
    descripcion={<span className={styles.heroDescription}>Kit de 6 cámaras Roboticas de 3mpx TENDA + 6 micro sd 64gb.</span>}
    precio="999,000"
  >
  </HeroHeader>
</Suspense>
      ...
      <Suspense fallback={<div>Cargando...</div>}>
        <Formulario
          titulo="confirma la Compra de las 6 cámaras tenda cp3 pro 3mpx + 6 memorias sd de 64 gb"
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "Product",
          "name": "Kit de 6 cámaras Roboticas de 3mpx TENDA + 6 micro sd 64gb imou",
          "image": [
            imagen1,
  imagen50,
  imagen51,
  ...
  Image1504,
        ...
        "description": "Kit de una 6 cámaras roboticas de (3mpx) TENDA + MICRO SD 64 GB IMOU, ideal para todo tipo de negocio, casa u oficina.",
        "brand": {
          "@type": "Brand",
          "name": "TENDA"
        },
